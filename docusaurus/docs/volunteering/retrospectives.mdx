...
Ms Boba will always be present in the retrospective, and always has things to complain about. It's unlikely
...
Note that not all issues can be solved or discussed immediately. If more urgent work is happening, the issue
may be postponed until a more appropriate time, potentially as part of the next retrospective.
