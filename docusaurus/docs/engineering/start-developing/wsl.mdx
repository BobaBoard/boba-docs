...
indicates items that should be installed into your chosen Linux distro (Ubuntu).
...
3. Follow the
   [instructions here](https://learn.microsoft.com/en-us/windows/wsl/install#upgrade-version-from-wsl-1-to-wsl-2)
   [<FontAwesomeIcon icon={faClock} /> 1 min] to verify you've installed WSL2 or
...
[Install BobaFrontend](/docs/engineering/start-developing/boba-frontend),
...
- Check out our other
  [Recommended Tools](/docs/engineering/knowledge-base/recommended-tools#recommended-vscode-extensions)
