...
This page offers a global overview of BobaBoard's current roadmap. You can also check out [our active sprints and projects](./sprint-and-projects)
...
2. **Organizational:** the BobaBoard organization must be able to coordinate one (or more) team of
   ...
   as well as finding the right community managers to further grow the community (soon to start ⏸).
...
For the most up-to-date information, check the [sprints and projects](./sprint-and-projects) page.
