...
BobaBoard's work is currently organized in a series of time-bound thematic sprints (e.g. "beta realm launch", "ui polish")
during which volunteers collaborate
...
We're currently working on a schedule of (~6-weeks long) thematic sprints. Sprints are usually meant to advance [overarching projects](#projects),
and may share issues with them.

Here you can see what we're currently working on, what we have upcoming, and what we're doing later on. The data is pulled directly from
our GitHub repository, and is automatically updated.

### Current sprints

<Projects tags={["sprint", "active"]} />

### Future sprints

<Projects tags={["sprint", "upcoming"]} />

### Closed sprints

<Projects tags={["sprint", "closed"]} />
