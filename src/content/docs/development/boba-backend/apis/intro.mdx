...
- **HTTP Response type:**
  [See endpoint documentation](/api/operations/getrealmsbyslug)
...
[`HTTP methods`](https://restapitutorial.com/introduction/httpmethods) to
...
use a tool like [Postman](../../using-postman) or write
...
can use a tool like [Postman](../../using-postman) or
