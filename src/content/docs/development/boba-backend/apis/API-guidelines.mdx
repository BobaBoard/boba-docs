...
These rules must be followed when creating new API endpoint in boba-backend.
...
1. **MUST** document every endpoint using the OpenAPI format (see
   [How to Write Documentation](../creating-endpoints#documenting-endpoints)).
...
6. **MUST** use HTTP methods correctly.
   ...
   - For a more compact explanation see
     [this guide](https://www.restapitutorial.com/introduction/httpmethods).
