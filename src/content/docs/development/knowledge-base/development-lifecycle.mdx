...
[Git Notes](/development/legacy-pages/git-notes.md) page.
...
[Recommended Tools](/development/knowledge-base/recommended-tools.md)
...
<Aside type="danger" title="Windows Subsystem for Linux (WSL)">
...
[](/development/start-developing/wsl).
...
<Aside type="tip" icon="star" title="Keep it short and sweet">
...
<Aside type="tip" icon="star"  title="Open Pull Requests Early">
...
<Aside type="note" title="How to Make Requested Changes">
...
<Aside type="tip" icon="star" title="Branch Maintenance">
