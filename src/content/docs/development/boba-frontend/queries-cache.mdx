...
1. **[Optimistic Updates](../../knowledge-base/caching#optimistic-updates):** we
...
- [QueryClient.setQueriesData](https://tanstack.com/query/latest/docs/reference/QueryClient?from=reactQueryV3#queryclientsetqueriesdata)
- [QueryClient.getQueriesData](https://tanstack.com/query/latest/docs/reference/QueryClient?from=reactQueryV3#queryclientgetqueriesdata)
