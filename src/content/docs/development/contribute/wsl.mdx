...
[Setup Your Development Environment](../setting-up-dev-env),
...
[Install boba-frontend](../boba-frontend),
[Install boba-backend](../boba-backend), or
[Install boba-components](../boba-components)
for more details.
...
- Check out our other
  [Recommended Tools](../../knowledge-base/recommended-tools#recommended-vscode-extensions)
