...
You can learn more about git and GitHub in [this article](https://docs.github.com/en/get-started/start-your-journey/about-github-and-git)
(or for a more in-depth look, consider [Volume 0 of The Fujoshi Guide to Web Development](https://www.fujoweb.dev/volume-0)).

For GitHub tutorials, check out the
[GitHub Learning Lab](https://github.com/apps/github-learning-lab).

For instructions on installing git, head to the
[Setup Your Development Environment](../../../../development/contribute/setting-up-dev-env#gitgithub)
guide.
...
Only the BobaLord is allowed to edit the original copy of boba-docs. This is
