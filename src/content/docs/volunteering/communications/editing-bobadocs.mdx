...
- A [GitHub](https://github.com) account. (A brief explanation of GitHub is
  available in our
  [Knowledge Base](/volunteering/coding/github/understanding-github). Any
...
[knowledge base](/volunteering/coding/github/understanding-github).
...
![a cropped screenshot of the boba-docs github page, with a red arrow pointing to the fork button](../../../../assets/img/volunteer/bobadocsfork.jpg)

<Aside type="tip" icon="star">

By the way! To do this right, you'd also need to branch. Read our
[knowledge base](/volunteering/coding/github/understanding-github) to learn
...
![a screenshot of github's editor with red arrows pointing to the preview and markdown guide buttons](../../../../assets/img/volunteer/bobadocseditor.jpg)
...
![a screenshot of github's editor preview. a red arrow is pointing to the "show diff" button](../../../../assets/img/volunteer/bobadocspreview.jpg)
...
![a screenshot of github's commit form. red arrows are pointing at the input textboxes and submit button](../../../../assets/img/volunteer/bobadocscommit.jpg)
...
![a screenshot of github's repo page, with a red arrow pointing to the pull request button](../../../../assets/img/volunteer/bobadocsaftercommit.jpg)
...
![github's pull request page. red arrows are pointing to the branch selection, details textboxes, and submit button](../../../../assets/img/volunteer/bobadocspullrequest.jpg)
