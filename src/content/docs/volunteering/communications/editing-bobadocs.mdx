...
- A [GitHub](https://github.com) account. (A brief explanation of GitHub is
  available in our
  [Knowledge Base](../../coding/github/understanding-github). Any
...
[knowledge base](../../coding/github/understanding-github).
...
2. Navigate to the main repo for the site at
   [https://github.com/BobaBoard/boba-docs](https://github.com/BobaBoard/boba-docs).
...
[knowledge base](../../coding/github/understanding-github) to learn
