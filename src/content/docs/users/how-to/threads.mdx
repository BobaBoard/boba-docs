...
first posted by selecting the preferred option at the bottom of the boba-editor.
...
in the bottom right corner, and start typing in the boba-editor! The boba-editor
...
<img
  src="/img/userguide/youdon't.png"
  alt="That's the neat thing: you don't."
/>
...
- **OP** - the blue OP badge identifies the Original Poster of the thread. This
  ...
  Please see
  [Etiquette: Posting Guidelines](/users/etiquette#posting-guidelines) for
  more information.
