...
The v0 Realm is currently not accepting more members.
...
sure to read
[content notices and other indicators](../how-to/tagging#cn) carefully.
...
[content notices](../how-to/tagging#cn) that might trigger or squick
...
[General BobaBoard Etiquette](../etiquette) without needing intense
...
Unfortunately, v0 is not currently accepting new members. We'll keep everyone updated when/if this changes in the future.

{/* Please email the realm admin listed for v0 on the
[Realm Admins](../admins) page. Please be sure to include the Realm
